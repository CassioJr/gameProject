...
public class aposController {
    ...
    /*Metodo que quando chamado coloca os valores de ouro e experiencia na tela ap�s o combate
    ...
    /*Metodo que chama a tela de espera ap�s o player clicar na tela do ap�s o combate*/
